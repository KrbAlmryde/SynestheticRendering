...
void main()
{
    ...
    for (int i = 0; i < MAX_SAMPLES; i++) {
        ...
        vec4 tfColor = texture(lut, sample);
...
//        vFragColor.rgb = prev_alpha * vec3(sample) + vFragColor.rgb;
        vFragColor.rgb = prev_alpha * tfColor.rgb + vFragColor.rgb;
        vFragColor.a += prev_alpha;

        
//        vFragColor.rgb = prev_alpha * tfColor.rgb + vFragColor.rgb;
//        tfColor.a *= 0.5f;
//        vFragColor = (1.0f - vFragColor.a) * tfColor + vFragColor;
